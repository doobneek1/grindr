...
.method public static synthetic a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/net/URL;
    .locals 0

    invoke-static {p0, p1, p2}, Lly/img/android/b;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/net/URL;
...
.method public static a()Lly/img/android/b;
    .locals 1
...
.method private static a(Ljava/lang/String;ILjava/lang/String;Lly/img/android/g;)Lly/img/android/g;
    .locals 0
    ...
    invoke-static {p2}, Lly/img/android/g;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method private a(Lly/img/android/b$a;)V
    .locals 2
...
.method public static synthetic a(Lly/img/android/b;)V
    .locals 0

    invoke-direct {p0}, Lly/img/android/b;->b()V

    return-void
.end method

.method public static synthetic a(Lly/img/android/b;Lly/img/android/b$a;)V
    .locals 0

    invoke-direct {p0, p1}, Lly/img/android/b;->a(Lly/img/android/b$a;)V

    return-void
.end method

.method private static b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/net/URL;
    .locals 3
...
.method private final c(Lly/img/android/i;)Lly/img/android/g;
    .locals 1
...
.method public final a(Landroid/content/Context;)V
    ...
    invoke-static {v0, v2, v3, v1}, Lly/img/android/b;->a(Ljava/lang/String;ILjava/lang/String;Lly/img/android/g;)Lly/img/android/g;

    move-result-object v0

    sget-object v1, Lly/img/android/i;->a:Lly/img/android/i;

    invoke-virtual {v0, v1}, Lly/img/android/g;->a(Lly/img/android/i;)Z
    ...
    invoke-direct {p0, v3}, Lly/img/android/b;->c(Lly/img/android/i;)Lly/img/android/g;

    move-result-object v1

    invoke-virtual {v1}, Lly/img/android/g;->f()Z
    ...
    invoke-direct {p0, v2}, Lly/img/android/b;->c(Lly/img/android/i;)Lly/img/android/g;
...
.method public final a(Lly/img/android/i;)Z
    ...
    invoke-direct {p0, p1}, Lly/img/android/b;->c(Lly/img/android/i;)Lly/img/android/g;
...
.method public final a(Lly/img/android/i;Lly/img/android/Feature;)Z
    .locals 0
    ...
    invoke-virtual {p1, p2}, Lly/img/android/g;->a(Lly/img/android/Feature;)Z
...
.method public final b(Lly/img/android/i;)V
    .locals 4
    ...
    invoke-virtual {p1, v1}, Lly/img/android/g;->a(Lly/img/android/Feature;)Z
    ...
    new-instance v0, Lly/img/android/b$b;

    invoke-virtual {p1}, Lly/img/android/g;->b()[Ljava/lang/String;
    ...
    invoke-direct {v0, v1, p1, v3}, Lly/img/android/b$b;-><init>([Ljava/lang/String;Ljava/lang/String;I)V
