...
.method private static getExceptionFrom(Lorg/minidns/hla/ResolverResult;)Lorg/minidns/hla/ResolutionUnsuccessfulException;
    ...
    .line 3
    new-instance v1, Lorg/minidns/hla/ResolutionUnsuccessfulException;

    invoke-direct {v1, v0, p0}, Lorg/minidns/hla/ResolutionUnsuccessfulException;-><init>(Lorg/minidns/dnsmessage/Question;Lorg/minidns/dnsmessage/DnsMessage$RESPONSE_CODE;)V
...
.method private static getResolver(Lorg/jivesoftware/smack/ConnectionConfiguration$DnssecMode;)Lorg/minidns/hla/ResolverApi;
    ...
    .line 2
    sget-object p0, Lorg/jivesoftware/smack/util/dns/minidns/MiniDnsResolver;->NON_DNSSEC_RESOLVER:Lorg/minidns/hla/ResolverApi;

    return-object p0

    .line 3
    :cond_0
    sget-object p0, Lorg/jivesoftware/smack/util/dns/minidns/MiniDnsResolver;->DNSSEC_RESOLVER:Lorg/minidns/hla/ResolverApi;
...
.method private static shouldAbortIfNotAuthentic(Lorg/minidns/dnsname/DnsName;Lorg/jivesoftware/smack/ConnectionConfiguration$DnssecMode;Lorg/minidns/hla/ResolverResult;Ljava/util/List;)Z
    ...
    check-cast p2, Lorg/minidns/dnssec/UnverifiedReason;

    invoke-virtual {p2}, Lorg/minidns/dnssec/UnverifiedReason;->getReasonString()Ljava/lang/String;
    ...
    invoke-direct {p2, p0, p1}, Lorg/jivesoftware/smack/util/dns/HostAddress;-><init>(Lorg/minidns/dnsname/DnsName;Ljava/lang/Exception;)V
...
.method public lookupHostAddress0(Lorg/minidns/dnsname/DnsName;Ljava/util/List;Lorg/jivesoftware/smack/ConnectionConfiguration$DnssecMode;)Ljava/util/List;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0}, Lorg/minidns/hla/ResolverResult;->wasSuccessful()Z
    ...
    invoke-direct {p3, p1, v2}, Lorg/jivesoftware/smack/util/dns/HostAddress;-><init>(Lorg/minidns/dnsname/DnsName;Ljava/lang/Exception;)V
    ...
    invoke-static {v0}, Lorg/jivesoftware/smack/util/dns/minidns/MiniDnsResolver;->getExceptionFrom(Lorg/minidns/hla/ResolverResult;)Lorg/minidns/hla/ResolutionUnsuccessfulException;

    move-result-object v0

    invoke-direct {p3, p1, v0}, Lorg/jivesoftware/smack/util/dns/HostAddress;-><init>(Lorg/minidns/dnsname/DnsName;Ljava/lang/Exception;)V
    ...
    .line 8
    invoke-static {p1, p3, v0, p2}, Lorg/jivesoftware/smack/util/dns/minidns/MiniDnsResolver;->shouldAbortIfNotAuthentic(Lorg/minidns/dnsname/DnsName;Lorg/jivesoftware/smack/ConnectionConfiguration$DnssecMode;Lorg/minidns/hla/ResolverResult;Ljava/util/List;)Z
    ...
    .line 13
    invoke-virtual {v0}, Lorg/minidns/hla/ResolverResult;->getAnswers()Ljava/util/Set;
    ...
    .line 18
    :try_start_1
    invoke-virtual {v1}, Lorg/minidns/record/InternetAddressRR;->getIp()[B
    ...
    check-cast p3, Lorg/minidns/record/AAAA;

    .line 21
    :try_start_2
    iget-object v1, p1, Lorg/minidns/dnsname/DnsName;->ace:Ljava/lang/String;

    invoke-virtual {p3}, Lorg/minidns/record/InternetAddressRR;->getIp()[B
    ...
    invoke-direct {v0, p1, p3}, Lorg/jivesoftware/smack/util/dns/HostAddress;-><init>(Lorg/minidns/dnsname/DnsName;Ljava/lang/Exception;)V
...
.method public lookupSRVRecords0(Lorg/minidns/dnsname/DnsName;Ljava/util/List;Lorg/jivesoftware/smack/ConnectionConfiguration$DnssecMode;)Ljava/util/List;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    :try_start_0
    invoke-virtual {v0, p1}, Lorg/minidns/hla/ResolverApi;->resolveSrv(Lorg/minidns/dnsname/DnsName;)Lorg/minidns/hla/SrvResolverResult;
    ...
    .line 3
    invoke-virtual {v0}, Lorg/minidns/hla/ResolverResult;->getResolutionUnsuccessfulException()Lorg/minidns/hla/ResolutionUnsuccessfulException;
    ...
    .line 8
    iget-object v4, v2, Lorg/minidns/record/SRV;->target:Lorg/minidns/dnsname/DnsName;

    .line 9
    invoke-virtual {p0, v4, p2, p3}, Lorg/jivesoftware/smack/util/dns/minidns/MiniDnsResolver;->lookupHostAddress0(Lorg/minidns/dnsname/DnsName;Ljava/util/List;Lorg/jivesoftware/smack/ConnectionConfiguration$DnssecMode;)Ljava/util/List;
    ...
    iget v5, v2, Lorg/minidns/record/SRV;->port:I

    iget v6, v2, Lorg/minidns/record/SRV;->priority:I

    iget v7, v2, Lorg/minidns/record/SRV;->weight:I

    move-object v3, v9

    invoke-direct/range {v3 .. v8}, Lorg/jivesoftware/smack/util/dns/SRVRecord;-><init>(Lorg/minidns/dnsname/DnsName;IIILjava/util/List;)V
