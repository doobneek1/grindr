...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/squareup/picasso/Picasso;Lzendesk/support/request/ActionFactory;Lzendesk/support/suas/Dispatcher;Lzendesk/core/ActionHandlerRegistry;Lzendesk/configurations/ConfigurationHelper;Lzendesk/configurations/Configuration;)V
    .locals 1
...
.method public constructor <init>(Lzendesk/support/request/CellBindHelper;Lzendesk/support/request/DocumentRenderer$HtmlParser;Lzendesk/support/request/DocumentRenderer;)V
    .locals 0
...
# virtual methods
.method public calculatePositionTypes(Ljava/util/List;)Ljava/util/List;
    .locals 7
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
...
.method public findFirstDelivered(Ljava/util/List;)Lzendesk/support/request/StateMessage;
    .locals 3
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
...
.method public findUserForId(Ljava/util/List;J)Lzendesk/support/request/StateRequestUser;
    .locals 3
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
...
.method public getAgentAttachment(Lzendesk/support/request/StateRequestAttachment;Lzendesk/support/request/StateRequestUser;Ljava/util/Date;)Lzendesk/support/request/CellType$Base;
    .locals 2
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
...
.method public getAgentMessage(Lzendesk/support/request/StateMessage;Lzendesk/support/request/StateRequestUser;)Lzendesk/support/request/CellType$Base;
    .locals 4
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
...
.method public getUserAttachment(Lzendesk/support/request/StateMessage;Lzendesk/support/request/StateRequestAttachment;Ljava/util/Date;)Lzendesk/support/request/CellType$Base;
    .locals 21
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
...
.method public getUserMessage(Lzendesk/support/request/StateMessage;)Ljava/util/List;
    .locals 10
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
...
.method public getViewModelsForMessage(Lzendesk/support/request/StateMessage;ZLzendesk/support/request/StateRequestUser;)Ljava/util/List;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public insertDateCells(Ljava/util/List;)Ljava/util/List;
    .locals 7
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
...
.method public insertRequestStatus(Ljava/util/List;Lzendesk/support/RequestStatus;)Ljava/util/List;
    .locals 2
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
...
.method public insertSystemMessage(Lzendesk/support/request/StateMessage;Lzendesk/support/request/StateMessage;Ljava/util/List;Ljava/lang/String;Z)Ljava/util/List;
    .locals 0
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
...
.method public isUserAgent(Lzendesk/support/request/StateRequestUser;)Z
    .locals 0
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
...
.method public markAgentCells(Ljava/util/List;)Ljava/util/List;
    .locals 9
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
...
.method public markCellsErrored(Ljava/util/List;)Ljava/util/List;
    .locals 7
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
...
.method public markLastDeliveredCell(Ljava/util/List;)Ljava/util/List;
    .locals 7
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
