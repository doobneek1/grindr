...
.method public onRunJob(Landroid/os/Bundle;Lcom/vungle/warren/tasks/JobRunner;)I
    ...
    const-string v6, "Placement %s is no longer valid, deleting it and its advertisement"
    ...
    const-string v8, "setting valid adv "
    ...
    const-string v6, "found adv in viewing state "
    ...
    const-string v6, "Deleting assets under directory %s"
