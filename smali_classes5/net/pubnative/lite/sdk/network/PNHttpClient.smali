...
.method private static synthetic lambda$makePendingRequest$3(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;)V
    ...
    .line 2
    invoke-static {v0}, Lnet/pubnative/lite/sdk/network/PNHttpClient$Response;->access$300(Lnet/pubnative/lite/sdk/network/PNHttpClient$Response;)Ljava/lang/Exception;
...
.method private static synthetic lambda$makeRequest$0(Lnet/pubnative/lite/sdk/network/PNHttpClient$Listener;Lnet/pubnative/lite/sdk/network/PNHttpClient$Response;)V
    ...
    invoke-static {p1}, Lnet/pubnative/lite/sdk/network/PNHttpClient$Response;->access$300(Lnet/pubnative/lite/sdk/network/PNHttpClient$Response;)Ljava/lang/Exception;
...
.method private static synthetic lambda$makeRequest$1(Lnet/pubnative/lite/sdk/network/PNHttpClient$Listener;Lnet/pubnative/lite/sdk/network/PNHttpClient$Response;)V
    ...
    invoke-interface {p0, p1}, Lnet/pubnative/lite/sdk/network/PNHttpClient$Listener;->onSuccess(Ljava/lang/String;)V
...
.method private static synthetic lambda$makeRequest$2(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;ZZLnet/pubnative/lite/sdk/network/PNHttpClient$Listener;Landroid/content/Context;)V
    ...
    invoke-interface {p5, p0}, Lnet/pubnative/lite/sdk/network/PNHttpClient$Listener;->onSuccess(Ljava/lang/String;)V
...
.method private static sendRequest(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;)Lnet/pubnative/lite/sdk/network/PNHttpClient$Response;
    ...
    invoke-static {p0}, Lcom/safedk/android/internal/partials/PubNativeNetworkBridge;->urlConnectionGetOutputStream(Ljava/net/URLConnection;)Ljava/io/OutputStream;
    ...
    .line 17
    :cond_1
    invoke-static {p0}, Lcom/safedk/android/internal/partials/PubNativeNetworkBridge;->httpUrlConnectionGetResponseCode(Ljava/net/HttpURLConnection;)I
    ...
    .line 21
    invoke-static {p0}, Lcom/safedk/android/internal/partials/PubNativeNetworkBridge;->urlConnectionGetInputStream(Ljava/net/URLConnection;)Ljava/io/InputStream;
    ...
    invoke-static {v0, p2}, Lnet/pubnative/lite/sdk/network/PNHttpClient$Response;->access$302(Lnet/pubnative/lite/sdk/network/PNHttpClient$Response;Ljava/lang/Exception;)Ljava/lang/Exception;
    :try_end_1
    ...
    .line 25
    :goto_1
    invoke-static {p0}, Lcom/safedk/android/internal/partials/PubNativeNetworkBridge;->httpUrlConnectionDisconnect(Ljava/net/HttpURLConnection;)V
    ...
    :goto_2
    :try_start_2
    invoke-static {v0, p1}, Lnet/pubnative/lite/sdk/network/PNHttpClient$Response;->access$302(Lnet/pubnative/lite/sdk/network/PNHttpClient$Response;Ljava/lang/Exception;)Ljava/lang/Exception;
    :try_end_2
