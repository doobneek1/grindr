...
.field private final alternateFormatsMap:Lj$/util/concurrent/ConcurrentHashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private final shortNumberMetadataMap:Lj$/util/concurrent/ConcurrentHashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lj$/util/concurrent/ConcurrentHashMap<",
            "Ljava/lang/String;",
...
.method public constructor <init>(Lio/michaelrocks/libphonenumber/android/MetadataLoader;)V
    ...
    iput-object v0, p0, Lio/michaelrocks/libphonenumber/android/MetadataManager;->alternateFormatsMap:Lj$/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v0, p0, Lio/michaelrocks/libphonenumber/android/MetadataManager;->shortNumberMetadataMap:Lj$/util/concurrent/ConcurrentHashMap;
...
.method public getAlternateFormatsForCountry(ILjava/lang/String;)Lio/michaelrocks/libphonenumber/android/Phonemetadata$PhoneMetadata;
    ...
    iget-object v0, p0, Lio/michaelrocks/libphonenumber/android/MetadataManager;->alternateFormatsMap:Lj$/util/concurrent/ConcurrentHashMap;

    invoke-virtual {p0, p1, v0, p2}, Lio/michaelrocks/libphonenumber/android/MetadataManager;->getMetadataFromMultiFilePrefix(Ljava/lang/Object;Lj$/util/concurrent/ConcurrentHashMap;Ljava/lang/String;)Lio/michaelrocks/libphonenumber/android/Phonemetadata$PhoneMetadata;
...
.method public getMetadataFromMultiFilePrefix(Ljava/lang/Object;Lj$/util/concurrent/ConcurrentHashMap;Ljava/lang/String;)Lio/michaelrocks/libphonenumber/android/Phonemetadata$PhoneMetadata;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 7
    invoke-virtual {p2, p1, p3}, Lj$/util/concurrent/ConcurrentHashMap;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
