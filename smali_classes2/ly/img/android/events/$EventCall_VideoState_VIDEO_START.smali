.class public Lly/img/android/events/$EventCall_VideoState_VIDEO_START;
...
.method public static constructor <clinit>()V
    ...
    new-instance v1, Lly/img/android/events/$EventCall_VideoState_VIDEO_START;

    invoke-direct {v1}, Lly/img/android/events/$EventCall_VideoState_VIDEO_START;-><init>()V
...
.method public call(Lly/img/android/pesdk/backend/model/EventSetInterface;Z)V
    ...
    check-cast v2, Lly/img/android/events/$EventCall_VideoState_VIDEO_START$Synchrony;

    invoke-interface {v2, v0, p2}, Lly/img/android/events/$EventCall_VideoState_VIDEO_START$Synchrony;->$callEvent_VideoState_VIDEO_START(Ljava/lang/Object;Z)V
    :try_end_0
...
.method public callInMainThread(Lly/img/android/pesdk/backend/model/EventSetInterface;Z)V
    ...
    check-cast v2, Lly/img/android/events/$EventCall_VideoState_VIDEO_START$MainThread;

    invoke-interface {v2, v0, p2}, Lly/img/android/events/$EventCall_VideoState_VIDEO_START$MainThread;->$callEvent_VideoState_VIDEO_START_MAIN_TREAD(Ljava/lang/Object;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public callOnWorkerThread(Lly/img/android/pesdk/backend/model/EventSetInterface;Z)V
    ...
    check-cast v2, Lly/img/android/events/$EventCall_VideoState_VIDEO_START$WorkerThread;

    invoke-interface {v2, v0, p2}, Lly/img/android/events/$EventCall_VideoState_VIDEO_START$WorkerThread;->$callEvent_VideoState_VIDEO_START_WORKER_THREAD(Ljava/lang/Object;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
