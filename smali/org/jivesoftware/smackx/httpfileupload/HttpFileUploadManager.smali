...
.method private static containsHttpFileUploadNamespace(Lorg/jivesoftware/smackx/disco/packet/DiscoverInfo;)Z
    ...
    const-string/jumbo v0, "urn:xmpp:http:upload:0"
    ...
    const-string/jumbo v0, "urn:xmpp:http:upload"
...
.method public static declared-synchronized getInstanceFor(Lorg/jivesoftware/smack/XMPPConnection;)Lorg/jivesoftware/smackx/httpfileupload/HttpFileUploadManager;
    ...
    check-cast v2, Lorg/jivesoftware/smackx/httpfileupload/HttpFileUploadManager;
...
.method private uploadFile(Ljava/io/File;Lorg/jivesoftware/smackx/httpfileupload/element/Slot;Lorg/jivesoftware/smackx/httpfileupload/UploadProgressListener;)V
    ...
    :cond_1
    :try_start_0
    invoke-static {v6}, Lcom/safedk/android/internal/partials/SmackNetworkBridge;->urlConnectionGetOutputStream(Ljava/net/URLConnection;)Ljava/io/OutputStream;
    ...
    .line 32
    :goto_3
    invoke-static {v6}, Lcom/safedk/android/internal/partials/SmackNetworkBridge;->httpUrlConnectionGetResponseCode(Ljava/net/HttpURLConnection;)I
    ...
    :cond_6
    :goto_4
    invoke-static {v6}, Lcom/safedk/android/internal/partials/SmackNetworkBridge;->httpUrlConnectionDisconnect(Ljava/net/HttpURLConnection;)V
...
.method private static uploadServiceFrom(Lorg/jivesoftware/smackx/disco/packet/DiscoverInfo;)Lorg/jivesoftware/smackx/httpfileupload/UploadService;
    ...
    invoke-direct {p0, v1, v0}, Lorg/jivesoftware/smackx/httpfileupload/UploadService;-><init>(Lorg/jxmpp/jid/DomainBareJid;Lorg/jivesoftware/smackx/httpfileupload/UploadService$Version;)V
    ...
    invoke-direct {v2, v1, v0, p0}, Lorg/jivesoftware/smackx/httpfileupload/UploadService;-><init>(Lorg/jxmpp/jid/DomainBareJid;Lorg/jivesoftware/smackx/httpfileupload/UploadService$Version;Ljava/lang/Long;)V
...
.method public discoverUploadService()Z
    ...
    const-string/jumbo v1, "urn:xmpp:http:upload:0"
    ...
    const-string/jumbo v1, "urn:xmpp:http:upload"
...
.method public requestSlot(Ljava/lang/String;JLjava/lang/String;Lorg/jxmpp/jid/DomainBareJid;)Lorg/jivesoftware/smackx/httpfileupload/element/Slot;
    ...
    .line 5
    invoke-virtual {v1}, Lorg/jivesoftware/smackx/httpfileupload/UploadService;->getAddress()Lorg/jxmpp/jid/DomainBareJid;

    move-result-object v2

    invoke-interface {v2, p5}, Lorg/jxmpp/jid/Jid;->equals(Ljava/lang/CharSequence;)Z
    ...
    invoke-virtual {v1, p5}, Lorg/jivesoftware/smackx/disco/ServiceDiscoveryManager;->discoverInfo(Lorg/jxmpp/jid/Jid;)Lorg/jivesoftware/smackx/disco/packet/DiscoverInfo;
    ...
    invoke-direct/range {v3 .. v8}, Lorg/jivesoftware/smackx/httpfileupload/element/SlotRequest_V0_2;-><init>(Lorg/jxmpp/jid/DomainBareJid;Ljava/lang/String;JLjava/lang/String;)V
    ...
    invoke-direct/range {v1 .. v6}, Lorg/jivesoftware/smackx/httpfileupload/element/SlotRequest;-><init>(Lorg/jxmpp/jid/DomainBareJid;Ljava/lang/String;JLjava/lang/String;)V
