.class public Lcom/safedk/android/internal/partials/ZendeskNetworkBridge;
...
.method public static okhttp3CallEnqueue(Lokhttp3/Call;Lokhttp3/Callback;)V
    ...
    const-string v0, "ZendeskNetwork|SafeDK: Partial-Network> Lcom/safedk/android/internal/partials/ZendeskNetworkBridge;->okhttp3CallEnqueue(Lokhttp3/Call;Lokhttp3/Callback;)V"
...
.method public static okhttp3CallExecute(Lokhttp3/Call;)Lokhttp3/Response;
    ...
    const-string v0, "ZendeskNetwork|SafeDK: Partial-Network> Lcom/safedk/android/internal/partials/ZendeskNetworkBridge;->okhttp3CallExecute(Lokhttp3/Call;)Lokhttp3/Response;"
...
.method public static okhttp3Response_body(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    const-string v0, "ZendeskNetwork|SafeDK: Partial-Network> Lcom/safedk/android/internal/partials/ZendeskNetworkBridge;->okhttp3Response_body(Lokhttp3/Response;)Lokhttp3/ResponseBody;"
...
.method public static retrofitCall_enqueue(Lretrofit2/Call;Lretrofit2/Callback;)V
    .locals 5
    ...
    const-string v0, "ZendeskNetwork|SafeDK: Partial-Network> Lcom/safedk/android/internal/partials/ZendeskNetworkBridge;->retrofitCall_enqueue(Lretrofit2/Call;Lretrofit2/Callback;)V"
    ...
    .prologue
    .line 378
    .local p0, "targetInstance":Lretrofit2/Call;, "Lretrofit2/Call<TT;>;"
    ...
    invoke-direct {v0, v3, v1}, Lcom/safedk/android/internal/partials/NetworkBridge$RequestInfo;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v4, "retrofitCall_enqueue request id:"
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v0, v1}, Lcom/safedk/android/internal/partials/NetworkBridge$RequestInfo;->a(Ljava/lang/String;)V
    :try_end_1
    .catch Ljava/lang/Throwable; {:try_start_1 .. :try_end_1} :catch_0
    ...
    const-string v3, "retrofitCall_enqueue error "
...
.method public static retrofitCall_execute(Lretrofit2/Call;)Lretrofit2/Response;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    const-string v0, "ZendeskNetwork|SafeDK: Partial-Network> Lcom/safedk/android/internal/partials/ZendeskNetworkBridge;->retrofitCall_execute(Lretrofit2/Call;)Lretrofit2/Response;"
    ...
    const-string v3, "retrofitCall_execute error "
...
.method public static retrofitExceptionCatchingRequestBody_source(Lokhttp3/ResponseBody;)Lokio/BufferedSource;
    ...
    const-string v0, "ZendeskNetwork|SafeDK: Partial-Network> Lcom/safedk/android/internal/partials/ZendeskNetworkBridge;->retrofitExceptionCatchingRequestBody_source(Lokhttp3/ResponseBody;)Lokio/BufferedSource;"
...
.method public static webviewLoadDataWithBaseURL(Landroid/webkit/WebView;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v0, "ZendeskNetwork|SafeDK: Partial-Network> Lcom/safedk/android/internal/partials/ZendeskNetworkBridge;->webviewLoadDataWithBaseURL(Landroid/webkit/WebView;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V"
