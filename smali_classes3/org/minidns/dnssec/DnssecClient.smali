...
.field private verifier:Lorg/minidns/dnssec/Verifier;
...
.method public constructor <init>(Lorg/minidns/DnsCache;)V
    ...
    .line 3
    new-instance p1, Lorg/minidns/dnssec/Verifier;

    invoke-direct {p1}, Lorg/minidns/dnssec/Verifier;-><init>()V

    iput-object p1, p0, Lorg/minidns/dnssec/DnssecClient;->verifier:Lorg/minidns/dnssec/Verifier;
...
.method private createDnssecMessage(Lorg/minidns/dnsmessage/DnsMessage;Ljava/util/Set;)Lorg/minidns/dnssec/DnssecMessage;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    const-class v0, Lorg/minidns/record/RRSIG;

    iget-object v1, p1, Lorg/minidns/dnsmessage/DnsMessage;->answerSection:Ljava/util/List;

    .line 2
    iget-object v2, p1, Lorg/minidns/dnsmessage/DnsMessage;->authoritySection:Ljava/util/List;

    .line 3
    iget-object v3, p1, Lorg/minidns/dnsmessage/DnsMessage;->additionalSection:Ljava/util/List;
    ...
    .line 5
    invoke-static {v4, v0, v1}, Lorg/minidns/record/Record;->filter(Ljava/util/Collection;Ljava/lang/Class;Ljava/util/Collection;)V

    .line 6
    invoke-static {v4, v0, v2}, Lorg/minidns/record/Record;->filter(Ljava/util/Collection;Ljava/lang/Class;Ljava/util/Collection;)V

    .line 7
    invoke-static {v4, v0, v3}, Lorg/minidns/record/Record;->filter(Ljava/util/Collection;Ljava/lang/Class;Ljava/util/Collection;)V

    .line 8
    invoke-virtual {p1}, Lorg/minidns/dnsmessage/DnsMessage;->asBuilder()Lorg/minidns/dnsmessage/DnsMessage$Builder;
    ...
    .line 10
    invoke-static {v1}, Lorg/minidns/dnssec/DnssecClient;->stripSignatureRecords(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    invoke-virtual {p1, v0}, Lorg/minidns/dnsmessage/DnsMessage$Builder;->setAnswers(Ljava/util/Collection;)Lorg/minidns/dnsmessage/DnsMessage$Builder;

    .line 11
    invoke-static {v2}, Lorg/minidns/dnssec/DnssecClient;->stripSignatureRecords(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    invoke-virtual {p1, v0}, Lorg/minidns/dnsmessage/DnsMessage$Builder;->setNameserverRecords(Ljava/util/Collection;)Lorg/minidns/dnsmessage/DnsMessage$Builder;
    ...
    invoke-virtual {p1, v0}, Lorg/minidns/dnsmessage/DnsMessage$Builder;->setAdditionalResourceRecords(Ljava/util/Collection;)Lorg/minidns/dnsmessage/DnsMessage$Builder;

    .line 13
    :cond_0
    new-instance v0, Lorg/minidns/dnssec/DnssecMessage;

    invoke-direct {v0, p1, v4, p2}, Lorg/minidns/dnssec/DnssecMessage;-><init>(Lorg/minidns/dnsmessage/DnsMessage$Builder;Ljava/util/Set;Ljava/util/Set;)V
...
.method private performVerification(Lorg/minidns/dnsmessage/Question;Lorg/minidns/dnsmessage/DnsMessage;)Lorg/minidns/dnssec/DnssecMessage;
    .locals 0
    ...
    .line 1
    :cond_0
    iget-boolean p1, p2, Lorg/minidns/dnsmessage/DnsMessage;->authenticData:Z

    if-eqz p1, :cond_1

    .line 2
    invoke-virtual {p2}, Lorg/minidns/dnsmessage/DnsMessage;->asBuilder()Lorg/minidns/dnsmessage/DnsMessage$Builder;

    move-result-object p1

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, Lorg/minidns/dnsmessage/DnsMessage$Builder;->setAuthenticData(Z)Lorg/minidns/dnsmessage/DnsMessage$Builder;
    ...
    .line 3
    :cond_1
    invoke-direct {p0, p2}, Lorg/minidns/dnssec/DnssecClient;->verify(Lorg/minidns/dnsmessage/DnsMessage;)Ljava/util/Set;

    move-result-object p1

    .line 4
    invoke-direct {p0, p2, p1}, Lorg/minidns/dnssec/DnssecClient;->createDnssecMessage(Lorg/minidns/dnsmessage/DnsMessage;Ljava/util/Set;)Lorg/minidns/dnssec/DnssecMessage;
...
.method private verifyAnswer(Lorg/minidns/dnsmessage/DnsMessage;)Ljava/util/Set;
    ...
    .line 4
    invoke-direct {p0, v0, v2, p1}, Lorg/minidns/dnssec/DnssecClient;->verifySignatures(Lorg/minidns/dnsmessage/Question;Ljava/util/Collection;Ljava/util/List;)Lorg/minidns/dnssec/DnssecClient$VerifySignaturesResult;
    ...
    .line 10
    :cond_1
    invoke-direct {p0, v0, v7}, Lorg/minidns/dnssec/DnssecClient;->verifySecureEntryPoint(Lorg/minidns/dnsmessage/Question;Lorg/minidns/record/Record;)Ljava/util/Set;
    ...
    .line 16
    :cond_4
    iget-boolean v6, v3, Lorg/minidns/dnssec/DnssecClient$VerifySignaturesResult;->sepSignaturePresent:Z
    ...
    .line 18
    :cond_5
    iget-boolean v1, v3, Lorg/minidns/dnssec/DnssecClient$VerifySignaturesResult;->sepSignatureRequired:Z

    if-eqz v1, :cond_6

    iget-boolean v1, v3, Lorg/minidns/dnssec/DnssecClient$VerifySignaturesResult;->sepSignaturePresent:Z

    if-nez v1, :cond_6

    .line 19
    new-instance v1, Lorg/minidns/dnssec/UnverifiedReason$NoSecureEntryPointReason;
    ...
    invoke-direct {v1, v3}, Lorg/minidns/dnssec/UnverifiedReason$NoSecureEntryPointReason;-><init>(Ljava/lang/String;)V
    ...
    .line 22
    new-instance p1, Lorg/minidns/dnssec/UnverifiedReason$NoSignaturesReason;

    invoke-direct {p1, v0}, Lorg/minidns/dnssec/UnverifiedReason$NoSignaturesReason;-><init>(Lorg/minidns/dnsmessage/Question;)V
...
.method private verifyNsec(Lorg/minidns/dnsmessage/DnsMessage;)Ljava/util/Set;
    ...
    .line 6
    iget-object v5, v6, Lorg/minidns/record/Record;->name:Lorg/minidns/dnsname/DnsName;
    ...
    .line 8
    sget-object v9, Lorg/minidns/dnssec/DnssecClient$1;->$SwitchMap$org$minidns$record$Record$TYPE:[I

    iget-object v10, v8, Lorg/minidns/record/Record;->type:Lorg/minidns/record/Record$TYPE;
    ...
    .line 9
    :cond_2
    iget-object v2, p0, Lorg/minidns/dnssec/DnssecClient;->verifier:Lorg/minidns/dnssec/Verifier;

    invoke-virtual {v2, v5, v8, v1}, Lorg/minidns/dnssec/Verifier;->verifyNsec3(Lorg/minidns/dnsname/DnsName;Lorg/minidns/record/Record;Lorg/minidns/dnsmessage/Question;)Lorg/minidns/dnssec/UnverifiedReason;
    ...
    invoke-virtual {v2, v8, v1}, Lorg/minidns/dnssec/Verifier;->verifyNsec(Lorg/minidns/record/Record;Lorg/minidns/dnsmessage/Question;)Lorg/minidns/dnssec/UnverifiedReason;
    ...
    .line 14
    invoke-direct {p0, v1, v3, p1}, Lorg/minidns/dnssec/DnssecClient;->verifySignatures(Lorg/minidns/dnsmessage/Question;Ljava/util/Collection;Ljava/util/List;)Lorg/minidns/dnssec/DnssecClient$VerifySignaturesResult;
    ...
    .line 15
    iget-object v4, v2, Lorg/minidns/dnssec/DnssecClient$VerifySignaturesResult;->reasons:Ljava/util/Set;
    ...
    .line 17
    :cond_8
    iget-object v2, v2, Lorg/minidns/dnssec/DnssecClient$VerifySignaturesResult;->reasons:Ljava/util/Set;
...
.method private verifySecureEntryPoint(Lorg/minidns/dnsmessage/Question;Lorg/minidns/record/Record;)Ljava/util/Set;
    ...
    .line 1
    iget-object p1, p2, Lorg/minidns/record/Record;->payloadData:Lorg/minidns/record/Data;

    check-cast p1, Lorg/minidns/record/DNSKEY;
    ...
    .line 5
    iget-object v1, p0, Lorg/minidns/dnssec/DnssecClient;->knownSeps:Ljava/util/Map;
    ...
    invoke-virtual {p1, v1}, Lorg/minidns/record/DNSKEY;->keyEquals([B)Z
    ...
    .line 6
    :cond_0
    new-instance p1, Lorg/minidns/dnssec/UnverifiedReason$ConflictsWithSep;

    invoke-direct {p1, p2}, Lorg/minidns/dnssec/UnverifiedReason$ConflictsWithSep;-><init>(Lorg/minidns/record/Record;)V
    ...
    .line 8
    new-instance p1, Lorg/minidns/dnssec/UnverifiedReason$NoRootSecureEntryPointReason;

    invoke-direct {p1}, Lorg/minidns/dnssec/UnverifiedReason$NoRootSecureEntryPointReason;-><init>()V
    ...
    invoke-virtual {p0, v3, v4}, Lorg/minidns/dnssec/DnssecClient;->queryDnssec(Ljava/lang/CharSequence;Lorg/minidns/record/Record$TYPE;)Lorg/minidns/dnssec/DnssecMessage;
    ...
    .line 10
    sget-object p1, Lorg/minidns/AbstractDnsClient;->LOGGER:Ljava/util/logging/Logger;
    ...
    .line 11
    :cond_3
    invoke-virtual {v3}, Lorg/minidns/dnssec/DnssecMessage;->getUnverifiedReasons()Ljava/util/Set;
    ...
    .line 12
    iget-object v5, v3, Lorg/minidns/dnsmessage/DnsMessage;->answerSection:Ljava/util/List;
    ...
    .line 13
    const-class v7, Lorg/minidns/record/DS;

    invoke-virtual {v6, v7}, Lorg/minidns/record/Record;->ifPossibleAs(Ljava/lang/Class;)Lorg/minidns/record/Record;
    ...
    check-cast v6, Lorg/minidns/record/DS;

    .line 15
    invoke-virtual {p1}, Lorg/minidns/record/DNSKEY;->getKeyTag()I

    move-result v7

    iget v8, v6, Lorg/minidns/record/DelegatingDnssecRR;->keyTag:I
    ...
    .line 18
    iget-object p1, p0, Lorg/minidns/dnssec/DnssecClient;->dlv:Lorg/minidns/dnsname/DnsName;
    ...
    invoke-virtual {p0, p1, v3}, Lorg/minidns/dnssec/DnssecClient;->queryDnssec(Ljava/lang/CharSequence;Lorg/minidns/record/Record$TYPE;)Lorg/minidns/dnssec/DnssecMessage;
    ...
    .line 21
    iget-object v3, p1, Lorg/minidns/dnsmessage/DnsMessage;->answerSection:Ljava/util/List;
    ...
    .line 22
    const-class v5, Lorg/minidns/record/DLV;
    ...
    .line 23
    :cond_9
    iget-object v5, p2, Lorg/minidns/record/Record;->payloadData:Lorg/minidns/record/Data;
    ...
    iget-object v6, v4, Lorg/minidns/record/Record;->payloadData:Lorg/minidns/record/Data;

    check-cast v6, Lorg/minidns/record/DLV;

    iget v6, v6, Lorg/minidns/record/DelegatingDnssecRR;->keyTag:I
    ...
    .line 25
    iget-object v1, v4, Lorg/minidns/record/Record;->payloadData:Lorg/minidns/record/Data;

    move-object v2, v1

    check-cast v2, Lorg/minidns/record/DelegatingDnssecRR;
    ...
    .line 27
    iget-object p1, p0, Lorg/minidns/dnssec/DnssecClient;->verifier:Lorg/minidns/dnssec/Verifier;

    invoke-virtual {p1, p2, v2}, Lorg/minidns/dnssec/Verifier;->verify(Lorg/minidns/record/Record;Lorg/minidns/record/DelegatingDnssecRR;)Lorg/minidns/dnssec/UnverifiedReason;
    ...
    .line 30
    new-instance p1, Lorg/minidns/dnssec/UnverifiedReason$NoTrustAnchorReason;

    iget-object p2, p2, Lorg/minidns/record/Record;->name:Lorg/minidns/dnsname/DnsName;

    iget-object p2, p2, Lorg/minidns/dnsname/DnsName;->ace:Ljava/lang/String;

    invoke-direct {p1, p2}, Lorg/minidns/dnssec/UnverifiedReason$NoTrustAnchorReason;-><init>(Ljava/lang/String;)V
...
.method private verifySignatures(Lorg/minidns/dnsmessage/Question;Ljava/util/Collection;Ljava/util/List;)Lorg/minidns/dnssec/DnssecClient$VerifySignaturesResult;
    ...
    .line 3
    new-instance v2, Lorg/minidns/dnssec/DnssecClient$VerifySignaturesResult;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, Lorg/minidns/dnssec/DnssecClient$VerifySignaturesResult;-><init>(Lorg/minidns/dnssec/DnssecClient;Lorg/minidns/dnssec/DnssecClient$1;)V
    ...
    .line 13
    iget-object p2, v2, Lorg/minidns/dnssec/DnssecClient$VerifySignaturesResult;->reasons:Ljava/util/Set;

    new-instance p3, Lorg/minidns/dnssec/UnverifiedReason$NoActiveSignaturesReason;

    invoke-direct {p3, p1, v1}, Lorg/minidns/dnssec/UnverifiedReason$NoActiveSignaturesReason;-><init>(Lorg/minidns/dnsmessage/Question;Ljava/util/List;)V
    ...
    new-instance p3, Lorg/minidns/dnssec/UnverifiedReason$NoSignaturesReason;

    invoke-direct {p3, p1}, Lorg/minidns/dnssec/UnverifiedReason$NoSignaturesReason;-><init>(Lorg/minidns/dnsmessage/Question;)V
    ...
    .line 22
    iget-object v6, v2, Lorg/minidns/dnssec/DnssecClient$VerifySignaturesResult;->reasons:Ljava/util/Set;
    ...
    .line 29
    iput-boolean v7, v2, Lorg/minidns/dnssec/DnssecClient$VerifySignaturesResult;->sepSignaturePresent:Z

    goto :goto_5

    .line 30
    :cond_9
    iput-boolean v7, v2, Lorg/minidns/dnssec/DnssecClient$VerifySignaturesResult;->sepSignatureRequired:Z
...
.method private verifySignedRecords(Lorg/minidns/dnsmessage/Question;Lorg/minidns/record/RRSIG;Ljava/util/List;)Ljava/util/Set;
    ...
    .line 1
    const-class v0, Lorg/minidns/record/DNSKEY;
    ...
    .line 4
    invoke-virtual {v3, v0}, Lorg/minidns/record/Record;->ifPossibleAs(Ljava/lang/Class;)Lorg/minidns/record/Record;
    ...
    .line 5
    :cond_1
    iget-object v5, v3, Lorg/minidns/record/Record;->payloadData:Lorg/minidns/record/Data;
    ...
    .line 6
    iget-object v0, v3, Lorg/minidns/record/Record;->payloadData:Lorg/minidns/record/Data;
    ...
    .line 8
    new-instance p2, Lorg/minidns/dnssec/UnverifiedReason$NoTrustAnchorReason;
    ...
    invoke-direct {p2, p1}, Lorg/minidns/dnssec/UnverifiedReason$NoTrustAnchorReason;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2, v3}, Lorg/minidns/dnssec/DnssecClient;->queryDnssec(Ljava/lang/CharSequence;Lorg/minidns/record/Record$TYPE;)Lorg/minidns/dnssec/DnssecMessage;
    ...
    .line 10
    invoke-virtual {v2}, Lorg/minidns/dnssec/DnssecMessage;->getUnverifiedReasons()Ljava/util/Set;
    ...
    invoke-virtual {p1, p3, p2, v4}, Lorg/minidns/dnssec/Verifier;->verify(Ljava/util/List;Lorg/minidns/record/RRSIG;Lorg/minidns/record/DNSKEY;)Lorg/minidns/dnssec/UnverifiedReason;
    ...
    iget-object p2, p2, Lorg/minidns/record/RRSIG;->signerName:Lorg/minidns/dnsname/DnsName;
    ...
    invoke-direct {p3, p1, p2}, Lorg/minidns/dnssec/DnssecValidationFailedException;-><init>(Lorg/minidns/dnsmessage/Question;Ljava/lang/String;)V
...
.method public isResponseCacheable(Lorg/minidns/dnsmessage/Question;Lorg/minidns/dnsmessage/DnsMessage;)Z
    ...
    invoke-super {p0, p1, p2}, Lorg/minidns/iterative/ReliableDnsClient;->isResponseCacheable(Lorg/minidns/dnsmessage/Question;Lorg/minidns/dnsmessage/DnsMessage;)Z
...
.method public newQuestion(Lorg/minidns/dnsmessage/DnsMessage$Builder;)Lorg/minidns/dnsmessage/DnsMessage$Builder;
    ...
    invoke-virtual {v1}, Lorg/minidns/source/DnsDataSource;->getUdpPayloadSize()I
...
.method public query(Lorg/minidns/dnsmessage/Question;)Lorg/minidns/dnsmessage/DnsMessage;
    ...
    invoke-virtual {p0, p1}, Lorg/minidns/dnssec/DnssecClient;->queryDnssec(Lorg/minidns/dnsmessage/Question;)Lorg/minidns/dnssec/DnssecMessage;
...
.method public queryDnssec(Ljava/lang/CharSequence;Lorg/minidns/record/Record$TYPE;)Lorg/minidns/dnssec/DnssecMessage;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 2
    invoke-super {p0, v0}, Lorg/minidns/AbstractDnsClient;->query(Lorg/minidns/dnsmessage/Question;)Lorg/minidns/dnsmessage/DnsMessage;

    move-result-object p1

    .line 3
    invoke-direct {p0, v0, p1}, Lorg/minidns/dnssec/DnssecClient;->performVerification(Lorg/minidns/dnsmessage/Question;Lorg/minidns/dnsmessage/DnsMessage;)Lorg/minidns/dnssec/DnssecMessage;
...
.method public queryDnssec(Lorg/minidns/dnsmessage/Question;)Lorg/minidns/dnssec/DnssecMessage;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 4
    invoke-super {p0, p1}, Lorg/minidns/AbstractDnsClient;->query(Lorg/minidns/dnsmessage/Question;)Lorg/minidns/dnsmessage/DnsMessage;

    move-result-object v0

    .line 5
    invoke-direct {p0, p1, v0}, Lorg/minidns/dnssec/DnssecClient;->performVerification(Lorg/minidns/dnsmessage/Question;Lorg/minidns/dnsmessage/DnsMessage;)Lorg/minidns/dnssec/DnssecMessage;
