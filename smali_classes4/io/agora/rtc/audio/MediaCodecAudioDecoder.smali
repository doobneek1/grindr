...
.method private createStreaming(IJ)Z
    ...
    :catch_0
    const-string p1, "Error when creating aac audio file decoder"
...
.method public static testNetworkUrlAvailable(Ljava/lang/String;)Z
    ...
    .line 6
    invoke-static {p0}, Lcom/safedk/android/internal/partials/AgoraNetworkBridge;->httpUrlConnectionGetResponseCode(Ljava/net/HttpURLConnection;)I
    ...
    .line 8
    :goto_0
    invoke-static {p0}, Lcom/safedk/android/internal/partials/AgoraNetworkBridge;->urlConnectionGetInputStream(Ljava/net/URLConnection;)Ljava/io/InputStream;
    ...
    .line 10
    :cond_1
    invoke-static {p0}, Lcom/safedk/android/internal/partials/AgoraNetworkBridge;->httpUrlConnectionDisconnect(Ljava/net/HttpURLConnection;)V
    ...
    invoke-static {v1}, Lcom/safedk/android/internal/partials/AgoraNetworkBridge;->httpUrlConnectionDisconnect(Ljava/net/HttpURLConnection;)V
...
.method public createAACStreaming(I)Z
    ...
    :catch_0
    const-string p1, "MediaCodec Audio Decoder"
