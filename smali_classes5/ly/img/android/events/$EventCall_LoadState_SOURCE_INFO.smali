.class public Lly/img/android/events/$EventCall_LoadState_SOURCE_INFO;
...
.method public static constructor <clinit>()V
    ...
    new-instance v1, Lly/img/android/events/$EventCall_LoadState_SOURCE_INFO;

    invoke-direct {v1}, Lly/img/android/events/$EventCall_LoadState_SOURCE_INFO;-><init>()V
...
.method public call(Lly/img/android/pesdk/backend/model/EventSetInterface;Z)V
    ...
    check-cast v2, Lly/img/android/events/$EventCall_LoadState_SOURCE_INFO$Synchrony;

    invoke-interface {v2, v0, p2}, Lly/img/android/events/$EventCall_LoadState_SOURCE_INFO$Synchrony;->$callEvent_LoadState_SOURCE_INFO(Ljava/lang/Object;Z)V
    :try_end_0
...
.method public callInMainThread(Lly/img/android/pesdk/backend/model/EventSetInterface;Z)V
    ...
    check-cast v2, Lly/img/android/events/$EventCall_LoadState_SOURCE_INFO$MainThread;

    invoke-interface {v2, v0, p2}, Lly/img/android/events/$EventCall_LoadState_SOURCE_INFO$MainThread;->$callEvent_LoadState_SOURCE_INFO_MAIN_TREAD(Ljava/lang/Object;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public callOnWorkerThread(Lly/img/android/pesdk/backend/model/EventSetInterface;Z)V
    ...
    check-cast v2, Lly/img/android/events/$EventCall_LoadState_SOURCE_INFO$WorkerThread;

    invoke-interface {v2, v0, p2}, Lly/img/android/events/$EventCall_LoadState_SOURCE_INFO$WorkerThread;->$callEvent_LoadState_SOURCE_INFO_WORKER_THREAD(Ljava/lang/Object;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
