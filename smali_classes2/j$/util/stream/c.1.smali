...
.method constructor <init>(Lj$/util/stream/c;I)V
    ...
    invoke-static {p2, v1}, Lj$/util/stream/j3;->a(II)I
    ...
    invoke-virtual {p0}, Lj$/util/stream/c;->u1()Z
...
.method private w1(I)Lj$/util/Spliterator;
    .locals 7
    ...
    invoke-virtual {v2}, Lj$/util/stream/c;->u1()Z
    ...
    invoke-virtual {v5, v4}, Lj$/util/stream/j3;->d(I)Z
    ...
    :cond_0
    invoke-virtual {v2, v0, v1}, Lj$/util/stream/c;->t1(Lj$/util/stream/G0;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    invoke-static {v4, v0}, Lj$/util/stream/j3;->a(II)I
    ...
    invoke-static {p1, v0}, Lj$/util/stream/j3;->a(II)I
    ...
    const-string/jumbo v0, "source already consumed or closed"
...
# virtual methods
.method final O0(Lj$/util/stream/u2;Lj$/util/Spliterator;)V
    .locals 2
    ...
    invoke-interface {p1, v0, v1}, Lj$/util/stream/u2;->p(J)V

    invoke-interface {p2, p1}, Lj$/util/Spliterator;->forEachRemaining(Lj$/util/function/Consumer;)V

    invoke-interface {p1}, Lj$/util/stream/u2;->o()V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/c;->P0(Lj$/util/stream/u2;Lj$/util/Spliterator;)V

    :goto_0
    return-void
.end method

.method final P0(Lj$/util/stream/u2;Lj$/util/Spliterator;)V
    .locals 3
    ...
    invoke-interface {p1, v1, v2}, Lj$/util/stream/u2;->p(J)V

    invoke-virtual {v0, p2, p1}, Lj$/util/stream/c;->o1(Lj$/util/Spliterator;Lj$/util/stream/u2;)V
...
.method final S0(Lj$/util/Spliterator;ZLj$/util/function/IntFunction;)Lj$/util/stream/S0;
    ...
    .line 2
    invoke-virtual {p0, p0, p1, p2, p3}, Lj$/util/stream/c;->n1(Lj$/util/stream/G0;Lj$/util/Spliterator;ZLj$/util/function/IntFunction;)Lj$/util/stream/S0;
    ...
    invoke-virtual {p0, v0, v1, p3}, Lj$/util/stream/G0;->f1(JLj$/util/function/IntFunction;)Lj$/util/stream/K0;

    move-result-object p2

    invoke-virtual {p0, p2, p1}, Lj$/util/stream/c;->i1(Lj$/util/stream/u2;Lj$/util/Spliterator;)Lj$/util/stream/u2;
...
.method final Y0()I
    ...
    :cond_0
    invoke-virtual {v0}, Lj$/util/stream/c;->p1()I
...
.method final i1(Lj$/util/stream/u2;Lj$/util/Spliterator;)Lj$/util/stream/u2;
    .locals 1
    ...
    .line 2
    invoke-virtual {p0, p1}, Lj$/util/stream/c;->j1(Lj$/util/stream/u2;)Lj$/util/stream/u2;

    move-result-object v0

    invoke-virtual {p0, v0, p2}, Lj$/util/stream/c;->O0(Lj$/util/stream/u2;Lj$/util/Spliterator;)V
...
.method final j1(Lj$/util/stream/u2;)Lj$/util/stream/u2;
    .locals 2
    ...
    invoke-virtual {v0, v1, p1}, Lj$/util/stream/c;->v1(ILj$/util/stream/u2;)Lj$/util/stream/u2;
...
.method final k1(Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    .line 2
    invoke-virtual {p0, p0, v0, p1}, Lj$/util/stream/c;->y1(Lj$/util/stream/G0;Lj$/util/function/Supplier;Z)Lj$/util/Spliterator;
...
.method final l1(Lj$/util/stream/S3;)Ljava/lang/Object;
    .locals 1
    ...
    .line 2
    invoke-interface {p1}, Lj$/util/stream/S3;->b()I

    move-result v0

    invoke-direct {p0, v0}, Lj$/util/stream/c;->w1(I)Lj$/util/Spliterator;

    move-result-object v0

    invoke-interface {p1, p0, v0}, Lj$/util/stream/S3;->c(Lj$/util/stream/G0;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/S3;->d(Lj$/util/stream/G0;Lj$/util/Spliterator;)Ljava/lang/Object;
...
.method final m1(Lj$/util/function/IntFunction;)Lj$/util/stream/S0;
    .locals 3
    ...
    invoke-direct {v0, v2}, Lj$/util/stream/c;->w1(I)Lj$/util/Spliterator;

    move-result-object v1

    invoke-virtual {p0, v0, v1, p1}, Lj$/util/stream/c;->s1(Lj$/util/stream/G0;Lj$/util/Spliterator;Lj$/util/function/IntFunction;)Lj$/util/stream/S0;
    ...
    :cond_0
    invoke-direct {p0, v2}, Lj$/util/stream/c;->w1(I)Lj$/util/Spliterator;
...
.method abstract n1(Lj$/util/stream/G0;Lj$/util/Spliterator;ZLj$/util/function/IntFunction;)Lj$/util/stream/S0;
.end method

.method abstract o1(Lj$/util/Spliterator;Lj$/util/stream/u2;)V
.end method
...
.method final synthetic r1()Lj$/util/Spliterator;
    .locals 1
...
.method s1(Lj$/util/stream/G0;Lj$/util/Spliterator;Lj$/util/function/IntFunction;)Lj$/util/stream/S0;
    .locals 0
...
.method public spliterator()Lj$/util/Spliterator;
    ...
    const-string/jumbo v1, "source already consumed or closed"
    ...
    .line 2
    invoke-virtual {p0, p0, v2, v0}, Lj$/util/stream/c;->y1(Lj$/util/stream/G0;Lj$/util/function/Supplier;Z)Lj$/util/Spliterator;
...
.method t1(Lj$/util/stream/G0;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    .locals 1

    sget-object v0, Lj$/util/stream/a;->a:Lj$/util/stream/a;

    invoke-virtual {p0, p1, p2, v0}, Lj$/util/stream/c;->s1(Lj$/util/stream/G0;Lj$/util/Spliterator;Lj$/util/function/IntFunction;)Lj$/util/stream/S0;
...
.method abstract u1()Z
.end method

.method abstract v1(ILj$/util/stream/u2;)Lj$/util/stream/u2;
.end method

.method final x1()Lj$/util/Spliterator;
    .locals 3
...
.method abstract y1(Lj$/util/stream/G0;Lj$/util/function/Supplier;Z)Lj$/util/Spliterator;
.end method
