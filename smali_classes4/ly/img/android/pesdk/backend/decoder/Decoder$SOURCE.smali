...
.method public static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lly/img/android/pesdk/backend/decoder/Decoder$SOURCE;

    const-string v3, "RESOURCE"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lly/img/android/pesdk/backend/decoder/Decoder$SOURCE;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lly/img/android/pesdk/backend/decoder/Decoder$SOURCE;->RESOURCE:Lly/img/android/pesdk/backend/decoder/Decoder$SOURCE;

    .line 3
    new-instance v3, Lly/img/android/pesdk/backend/decoder/Decoder$SOURCE;

    const-string v5, "URI"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lly/img/android/pesdk/backend/decoder/Decoder$SOURCE;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lly/img/android/pesdk/backend/decoder/Decoder$SOURCE;->URI:Lly/img/android/pesdk/backend/decoder/Decoder$SOURCE;

    .line 4
    new-instance v5, Lly/img/android/pesdk/backend/decoder/Decoder$SOURCE;

    const-string v7, "NONE"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lly/img/android/pesdk/backend/decoder/Decoder$SOURCE;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lly/img/android/pesdk/backend/decoder/Decoder$SOURCE;->NONE:Lly/img/android/pesdk/backend/decoder/Decoder$SOURCE;

    const/4 v7, 0x4

    new-array v7, v7, [Lly/img/android/pesdk/backend/decoder/Decoder$SOURCE;
    ...
    .line 5
    sput-object v7, Lly/img/android/pesdk/backend/decoder/Decoder$SOURCE;->$VALUES:[Lly/img/android/pesdk/backend/decoder/Decoder$SOURCE;
