.class public interface abstract Lcom/grindrapp/android/persistence/dao/TagSearchProfileDao;
...
.method public abstract clearExpiredProfile(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .annotation build Landroidx/room/Query;
        value = "DELETE FROM tagsearch_profile WHERE NOT EXISTS(SELECT NULL FROM profile P WHERE P.profile_id = id)"
    .end annotation
...
.method public abstract delete(Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .annotation build Landroidx/room/Query;
        value = "DELETE FROM tagsearch_profile WHERE id = :id"
    .end annotation
...
.method public abstract delete(Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .annotation build Landroidx/room/Query;
        value = "DELETE FROM tagsearch_profile WHERE id IN (:profileIds)"
    .end annotation
...
.method public abstract deleteAll(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .annotation build Landroidx/room/Query;
        value = "DELETE FROM tagsearch_profile"
    .end annotation
...
.method public abstract queryAll(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .annotation build Landroidx/room/Query;
        value = "SELECT * FROM tagsearch_profile"
    .end annotation
...
.method public abstract queryAllIds(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .annotation build Landroidx/room/Query;
        value = "SELECT id FROM tagsearch_profile"
    .end annotation
