...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lly/img/android/pesdk/ui/model/state/$UiState_EventAccessor;->synchronyEventNames:[Ljava/lang/String;
    ...
    .line 2
    sput-object v1, Lly/img/android/pesdk/ui/model/state/$UiState_EventAccessor;->mainThreadEventNames:[Ljava/lang/String;

    new-array v0, v0, [Ljava/lang/String;

    .line 3
    sput-object v0, Lly/img/android/pesdk/ui/model/state/$UiState_EventAccessor;->workerThreadEventNames:[Ljava/lang/String;
...
# virtual methods
.method public bridge synthetic $callEvent_UiStateMenu_TOOL_STACK_CHANGED(Ljava/lang/Object;Z)V
    .locals 0

    .line 1
    check-cast p1, Lly/img/android/pesdk/ui/model/state/UiState;

    invoke-virtual {p0, p1, p2}, Lly/img/android/pesdk/ui/model/state/$UiState_EventAccessor;->$callEvent_UiStateMenu_TOOL_STACK_CHANGED(Lly/img/android/pesdk/ui/model/state/UiState;Z)V

    return-void
.end method

.method public $callEvent_UiStateMenu_TOOL_STACK_CHANGED(Lly/img/android/pesdk/ui/model/state/UiState;Z)V
    .locals 0
    ...
    invoke-virtual {p1, p2}, Lly/img/android/pesdk/ui/model/state/UiState;->setToolState(Lly/img/android/pesdk/ui/model/state/UiStateMenu;)V
...
.method public declared-synchronized add(Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, v0}, Lly/img/android/pesdk/ui/model/state/UiState;->setToolState(Lly/img/android/pesdk/ui/model/state/UiStateMenu;)V
    :try_end_0
...
.method public getMainThreadEventNames()[Ljava/lang/String;
    ...
    sget-object v0, Lly/img/android/pesdk/ui/model/state/$UiState_EventAccessor;->mainThreadEventNames:[Ljava/lang/String;
...
.method public getSynchronyEventNames()[Ljava/lang/String;
    ...
    sget-object v0, Lly/img/android/pesdk/ui/model/state/$UiState_EventAccessor;->synchronyEventNames:[Ljava/lang/String;
...
.method public getWorkerThreadEventNames()[Ljava/lang/String;
    ...
    sget-object v0, Lly/img/android/pesdk/ui/model/state/$UiState_EventAccessor;->workerThreadEventNames:[Ljava/lang/String;
