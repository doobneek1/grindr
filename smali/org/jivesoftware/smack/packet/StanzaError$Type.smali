...
.method public static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lorg/jivesoftware/smack/packet/StanzaError$Type;

    const-string v3, "CANCEL"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lorg/jivesoftware/smack/packet/StanzaError$Type;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lorg/jivesoftware/smack/packet/StanzaError$Type;->CANCEL:Lorg/jivesoftware/smack/packet/StanzaError$Type;

    .line 3
    new-instance v3, Lorg/jivesoftware/smack/packet/StanzaError$Type;

    const-string v5, "MODIFY"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lorg/jivesoftware/smack/packet/StanzaError$Type;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lorg/jivesoftware/smack/packet/StanzaError$Type;->MODIFY:Lorg/jivesoftware/smack/packet/StanzaError$Type;

    .line 4
    new-instance v5, Lorg/jivesoftware/smack/packet/StanzaError$Type;

    const-string v7, "AUTH"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lorg/jivesoftware/smack/packet/StanzaError$Type;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lorg/jivesoftware/smack/packet/StanzaError$Type;->AUTH:Lorg/jivesoftware/smack/packet/StanzaError$Type;

    .line 5
    new-instance v7, Lorg/jivesoftware/smack/packet/StanzaError$Type;

    const-string v9, "CONTINUE"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lorg/jivesoftware/smack/packet/StanzaError$Type;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lorg/jivesoftware/smack/packet/StanzaError$Type;->CONTINUE:Lorg/jivesoftware/smack/packet/StanzaError$Type;

    const/4 v9, 0x5

    new-array v9, v9, [Lorg/jivesoftware/smack/packet/StanzaError$Type;
    ...
    .line 6
    sput-object v9, Lorg/jivesoftware/smack/packet/StanzaError$Type;->$VALUES:[Lorg/jivesoftware/smack/packet/StanzaError$Type;
