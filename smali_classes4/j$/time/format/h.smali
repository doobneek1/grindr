...
.method constructor <init>(Lj$/time/temporal/TemporalField;IIZ)V
    ...
    invoke-virtual {v0}, Lj$/time/temporal/t;->f()Z
...
.method public final a(Lj$/time/format/y;Ljava/lang/StringBuilder;)Z
    ...
    invoke-interface {v0}, Lj$/time/temporal/TemporalField;->c()Lj$/time/temporal/t;

    move-result-object v0

    iget-object v4, p0, Lj$/time/format/h;->a:Lj$/time/temporal/TemporalField;

    invoke-virtual {v0, v2, v3, v4}, Lj$/time/temporal/t;->b(JLj$/time/temporal/TemporalField;)J
...
.method public final b(Lj$/time/format/w;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {p1}, Lj$/time/format/w;->g()Lj$/time/format/B;
    ...
    invoke-virtual {v5, v2}, Lj$/time/format/B;->a(C)I
    ...
    invoke-interface {p3}, Lj$/time/temporal/TemporalField;->c()Lj$/time/temporal/t;
