...
.implements Lly/img/android/events/$EventCall_TransformSettings_HORIZONTAL_FLIP$Synchrony;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        ">;",
        "Lly/img/android/events/$EventCall_TransformSettings_HORIZONTAL_FLIP$Synchrony<",
        "Lly/img/android/pesdk/backend/layer/TextGlLayer;",
        ">;"
    }
.end annotation
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lly/img/android/pesdk/backend/layer/$TextGlLayer_EventAccessor;->synchronyEventNames:[Ljava/lang/String;
    ...
    sput-object v0, Lly/img/android/pesdk/backend/layer/$TextGlLayer_EventAccessor;->mainThreadEventNames:[Ljava/lang/String;
    ...
    .line 3
    sput-object v0, Lly/img/android/pesdk/backend/layer/$TextGlLayer_EventAccessor;->workerThreadEventNames:[Ljava/lang/String;
...
.method public bridge synthetic $callEvent_EditorShowState_TRANSFORMATION_MAIN_TREAD(Ljava/lang/Object;Z)V
    ...
    invoke-virtual {p0, p1, p2}, Lly/img/android/pesdk/backend/layer/$TextGlLayer_EventAccessor;->$callEvent_EditorShowState_TRANSFORMATION_MAIN_TREAD(Lly/img/android/pesdk/backend/layer/TextGlLayer;Z)V

    return-void
.end method

.method public $callEvent_EditorShowState_TRANSFORMATION_MAIN_TREAD(Lly/img/android/pesdk/backend/layer/TextGlLayer;Z)V
    .locals 0
    ...
    invoke-virtual {p1, p2}, Lly/img/android/pesdk/backend/layer/TextGlLayer;->onWorldTransformationChanged(Lly/img/android/pesdk/backend/model/state/EditorShowState;)V

    return-void
.end method

.method public bridge synthetic $callEvent_TransformSettings_HORIZONTAL_FLIP(Ljava/lang/Object;Z)V
    .locals 0

    .line 1
    check-cast p1, Lly/img/android/pesdk/backend/layer/TextGlLayer;

    invoke-virtual {p0, p1, p2}, Lly/img/android/pesdk/backend/layer/$TextGlLayer_EventAccessor;->$callEvent_TransformSettings_HORIZONTAL_FLIP(Lly/img/android/pesdk/backend/layer/TextGlLayer;Z)V

    return-void
.end method

.method public $callEvent_TransformSettings_HORIZONTAL_FLIP(Lly/img/android/pesdk/backend/layer/TextGlLayer;Z)V
    .locals 0
    ...
    invoke-virtual {p1, p2}, Lly/img/android/pesdk/backend/layer/TextGlLayer;->onFlipImage(Lly/img/android/pesdk/backend/model/state/TransformSettings;)V
...
.method public declared-synchronized add(Ljava/lang/Object;)V
    ...
    .line 4
    new-instance v0, Lly/img/android/pesdk/backend/layer/$TextGlLayer_EventAccessor$1;

    invoke-direct {v0, p0, p1}, Lly/img/android/pesdk/backend/layer/$TextGlLayer_EventAccessor$1;-><init>(Lly/img/android/pesdk/backend/layer/$TextGlLayer_EventAccessor;Lly/img/android/pesdk/backend/layer/TextGlLayer;)V
    ...
    invoke-virtual {p1, v0}, Lly/img/android/pesdk/backend/layer/TextGlLayer;->onFlipImage(Lly/img/android/pesdk/backend/model/state/TransformSettings;)V
    :try_end_0
...
.method public getMainThreadEventNames()[Ljava/lang/String;
    ...
    sget-object v0, Lly/img/android/pesdk/backend/layer/$TextGlLayer_EventAccessor;->mainThreadEventNames:[Ljava/lang/String;
...
.method public getSynchronyEventNames()[Ljava/lang/String;
    ...
    sget-object v0, Lly/img/android/pesdk/backend/layer/$TextGlLayer_EventAccessor;->synchronyEventNames:[Ljava/lang/String;
...
.method public getWorkerThreadEventNames()[Ljava/lang/String;
    ...
    sget-object v0, Lly/img/android/pesdk/backend/layer/$TextGlLayer_EventAccessor;->workerThreadEventNames:[Ljava/lang/String;
