...
.method private static D(III)Lj$/time/LocalDate;
    .locals 3
...
.method public static now()Lj$/time/LocalDate;
    ...
    .line 2
    invoke-virtual {v0}, Lj$/time/c;->instant()Lj$/time/Instant;

    move-result-object v1

    invoke-virtual {v0}, Lj$/time/c;->b()Lj$/time/ZoneId;
    ...
    invoke-static {v1, v2, v3, v4}, Lj$/time/a;->i(JJ)J
...
.method private o(Lj$/time/temporal/TemporalField;)I
    .locals 3
    ...
    invoke-virtual {p1}, Lj$/time/DayOfWeek;->j()I
...
.method public static of(III)Lj$/time/LocalDate;
    ...
    invoke-virtual {v0, v3, v4}, Lj$/time/temporal/ChronoField;->j(J)J
...
.method private v(Lj$/time/LocalDate;)J
    .locals 8

    invoke-direct {p0}, Lj$/time/LocalDate;->r()J
    ...
    .line 2
    invoke-direct {p1}, Lj$/time/LocalDate;->r()J
...
.method public static w(J)Lj$/time/LocalDate;
    .locals 23
    ...
    invoke-virtual {v1, v11, v12}, Lj$/time/temporal/ChronoField;->i(J)I
...
.method public static x(II)Lj$/time/LocalDate;
    .locals 5
    ...
    invoke-virtual {v1, v0}, Lj$/time/Month;->j(Z)I
    ...
    invoke-virtual {v1}, Lj$/time/Month;->l()Lj$/time/Month;
    ...
    invoke-virtual {v1}, Lj$/time/Month;->k()I
...
# virtual methods
.method public final A(J)Lj$/time/LocalDate;
    .locals 6
    ...
    invoke-static {p1, p2, v0}, Lj$/time/LocalDate;->D(III)Lj$/time/LocalDate;
...
.method public final B(J)Lj$/time/LocalDate;
    .locals 2
...
.method public final C(J)Lj$/time/LocalDate;
    .locals 3
...
.method public final F(Lj$/time/temporal/TemporalField;J)Lj$/time/LocalDate;
    .locals 4
    ...
    invoke-virtual {p0, p1}, Lj$/time/LocalDate;->e(Lj$/time/temporal/TemporalField;)J
    ...
    invoke-virtual {p0, v1}, Lj$/time/LocalDate;->I(I)Lj$/time/LocalDate;
    ...
    invoke-virtual {p0, p1}, Lj$/time/LocalDate;->I(I)Lj$/time/LocalDate;
    ...
    invoke-virtual {p0, p2, p3}, Lj$/time/LocalDate;->A(J)Lj$/time/LocalDate;
    ...
    invoke-static {p2, p1, p3}, Lj$/time/LocalDate;->D(III)Lj$/time/LocalDate;
    ...
    invoke-virtual {p0, p2, p3}, Lj$/time/LocalDate;->B(J)Lj$/time/LocalDate;
    ...
    :pswitch_5
    invoke-static {p2, p3}, Lj$/time/LocalDate;->w(J)Lj$/time/LocalDate;
    ...
    invoke-static {p2, p1}, Lj$/time/LocalDate;->x(II)Lj$/time/LocalDate;
...
.method public final G(Lj$/time/temporal/i;)Lj$/time/chrono/b;
    .locals 1
...
.method public final H()Lj$/time/LocalDate;
    ...
    invoke-static {v0, v1}, Lj$/time/LocalDate;->x(II)Lj$/time/LocalDate;
...
.method public final I(I)Lj$/time/LocalDate;
    .locals 3
    ...
    invoke-static {p1, v0, v1}, Lj$/time/LocalDate;->D(III)Lj$/time/LocalDate;
...
.method public atStartOfDay(Lj$/time/ZoneId;)Lj$/time/ZonedDateTime;
    ...
    invoke-virtual {v1}, Lj$/time/zone/a;->h()Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-virtual {v1}, Lj$/time/zone/a;->a()Lj$/time/LocalDateTime;
    ...
    .line 5
    invoke-static {v0, p1, v1}, Lj$/time/ZonedDateTime;->o(Lj$/time/LocalDateTime;Lj$/time/ZoneId;Lj$/time/q;)Lj$/time/ZonedDateTime;
...
.method public final bridge synthetic b(Lj$/time/temporal/TemporalField;J)Lj$/time/temporal/Temporal;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/LocalDate;->F(Lj$/time/temporal/TemporalField;J)Lj$/time/LocalDate;
...
.method public final c(Lj$/time/temporal/TemporalField;)I
    ...
    invoke-direct {p0, p1}, Lj$/time/LocalDate;->o(Lj$/time/temporal/TemporalField;)I
...
.method public final bridge synthetic compareTo(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, Lj$/time/LocalDate;->k(Lj$/time/chrono/b;)I
...
.method public final d(Lj$/time/temporal/TemporalField;)Lj$/time/temporal/t;
    ...
    .line 2
    :goto_0
    invoke-static {v4, v5, v0, v1}, Lj$/time/temporal/t;->i(JJ)Lj$/time/temporal/t;
...
.method public final bridge synthetic f(JLj$/time/temporal/TemporalUnit;)Lj$/time/temporal/Temporal;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/LocalDate;->y(JLj$/time/temporal/TemporalUnit;)Lj$/time/LocalDate;
...
.method public final h(Lj$/time/temporal/Temporal;Lj$/time/temporal/TemporalUnit;)J
    ...
    :pswitch_1
    invoke-direct {p0, p1}, Lj$/time/LocalDate;->v(Lj$/time/LocalDate;)J
    ...
    .line 1
    :pswitch_6
    invoke-virtual {p1}, Lj$/time/LocalDate;->E()J
...
.method public final j(Lj$/time/temporal/Temporal;)Lj$/time/temporal/Temporal;
    ...
    invoke-interface {p1, v0, v1, v2}, Lj$/time/temporal/Temporal;->b(Lj$/time/temporal/TemporalField;J)Lj$/time/temporal/Temporal;
...
.method public final q()I
    ...
    invoke-virtual {v0, v1}, Lj$/time/Month;->j(Z)I
...
.method public final u(JLj$/time/temporal/TemporalUnit;)Lj$/time/chrono/b;
    .locals 2
    ...
    invoke-virtual {p1, v0, v1, p3}, Lj$/time/LocalDate;->y(JLj$/time/temporal/TemporalUnit;)Lj$/time/LocalDate;
...
.method public final y(JLj$/time/temporal/TemporalUnit;)Lj$/time/LocalDate;
    .locals 2
    ...
    invoke-virtual {p0, p3, p1, p2}, Lj$/time/LocalDate;->F(Lj$/time/temporal/TemporalField;J)Lj$/time/LocalDate;
    ...
    invoke-virtual {p0, p1, p2}, Lj$/time/LocalDate;->C(J)Lj$/time/LocalDate;
    ...
    :pswitch_5
    invoke-virtual {p0, p1, p2}, Lj$/time/LocalDate;->A(J)Lj$/time/LocalDate;
    ...
    :pswitch_6
    invoke-virtual {p0, p1, p2}, Lj$/time/LocalDate;->B(J)Lj$/time/LocalDate;
