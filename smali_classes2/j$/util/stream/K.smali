...
.method public static synthetic i0(Lj$/util/stream/L;)Ljava/util/stream/DoubleStream;
    .locals 1
...
.method public final synthetic allMatch(Ljava/util/function/DoublePredicate;)Z
    ...
    invoke-static {p1}, Lj$/util/function/p;->b(Ljava/util/function/DoublePredicate;)Lj$/util/function/r;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/L;->L(Lj$/util/function/r;)Z
...
.method public final synthetic anyMatch(Ljava/util/function/DoublePredicate;)Z
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/L;->S(Lj$/util/function/r;)Z
...
.method public final synthetic average()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/L;->average()Lj$/util/OptionalDouble;
...
.method public final synthetic collect(Ljava/util/function/Supplier;Ljava/util/function/ObjDoubleConsumer;Ljava/util/function/BiConsumer;)Ljava/lang/Object;
    ...
    invoke-static {p2}, Lj$/util/function/v0;->a(Ljava/util/function/ObjDoubleConsumer;)Lj$/util/function/x0;
    ...
    invoke-interface {v0, p1, p2, p3}, Lj$/util/stream/L;->z(Lj$/util/function/Supplier;Lj$/util/function/x0;Lj$/util/function/BiConsumer;)Ljava/lang/Object;
...
.method public final synthetic filter(Ljava/util/function/DoublePredicate;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/L;->q(Lj$/util/function/r;)Lj$/util/stream/L;
...
.method public final synthetic findAny()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/L;->findAny()Lj$/util/OptionalDouble;
...
.method public final synthetic findFirst()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/L;->findFirst()Lj$/util/OptionalDouble;
...
.method public final synthetic flatMap(Ljava/util/function/DoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/L;->r(Lj$/util/function/o;)Lj$/util/stream/L;
...
.method public final synthetic forEach(Ljava/util/function/DoubleConsumer;)V
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/L;->k(Lj$/util/function/l;)V
...
.method public final synthetic forEachOrdered(Ljava/util/function/DoubleConsumer;)V
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/L;->f0(Lj$/util/function/l;)V
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/L;->iterator()Lj$/util/n;

    move-result-object v0

    invoke-static {v0}, Lj$/util/m;->a(Lj$/util/n;)Ljava/util/PrimitiveIterator$OfDouble;
...
.method public final synthetic map(Ljava/util/function/DoubleUnaryOperator;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/L;->D(Lj$/util/function/A;)Lj$/util/stream/L;
...
.method public final synthetic mapToInt(Ljava/util/function/DoubleToIntFunction;)Ljava/util/stream/IntStream;
    ...
    invoke-static {p1}, Lj$/util/function/s;->b(Ljava/util/function/DoubleToIntFunction;)Lj$/util/function/u;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/L;->g0(Lj$/util/function/u;)Lj$/util/stream/IntStream;
...
.method public final synthetic mapToLong(Ljava/util/function/DoubleToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-static {p1}, Lj$/util/function/v;->a(Ljava/util/function/DoubleToLongFunction;)Lj$/util/function/x;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/L;->s(Lj$/util/function/x;)Lj$/util/stream/x0;
...
.method public final synthetic mapToObj(Ljava/util/function/DoubleFunction;)Ljava/util/stream/Stream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/L;->E(Lj$/util/function/o;)Lj$/util/stream/Stream;
...
.method public final synthetic max()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/L;->max()Lj$/util/OptionalDouble;
...
.method public final synthetic min()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/L;->min()Lj$/util/OptionalDouble;
...
.method public final synthetic noneMatch(Ljava/util/function/DoublePredicate;)Z
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/L;->F(Lj$/util/function/r;)Z
...
.method public final synthetic peek(Ljava/util/function/DoubleConsumer;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/L;->d(Lj$/util/function/l;)Lj$/util/stream/L;
...
.method public final synthetic reduce(DLjava/util/function/DoubleBinaryOperator;)D
    ...
    invoke-interface {v0, p1, p2, p3}, Lj$/util/stream/L;->C(DLj$/util/function/h;)D
...
.method public final synthetic reduce(Ljava/util/function/DoubleBinaryOperator;)Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/L;->y(Lj$/util/function/h;)Lj$/util/OptionalDouble;

    move-result-object p1

    invoke-static {p1}, Lj$/util/i;->f(Lj$/util/OptionalDouble;)Ljava/util/OptionalDouble;
...
.method public final synthetic spliterator()Ljava/util/Spliterator$OfDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/L;->spliterator()Lj$/util/A;
...
.method public final summaryStatistics()Ljava/util/DoubleSummaryStatistics;
    ...
    invoke-interface {v0}, Lj$/util/stream/L;->summaryStatistics()Lj$/util/f;
