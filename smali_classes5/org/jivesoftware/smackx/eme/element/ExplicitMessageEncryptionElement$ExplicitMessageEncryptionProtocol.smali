...
.method public static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lorg/jivesoftware/smackx/eme/element/ExplicitMessageEncryptionElement$ExplicitMessageEncryptionProtocol;

    const-string v3, "otrV0"

    const/4 v4, 0x1

    const-string v5, "urn:xmpp:otr:0"

    const-string v6, "Off-the-Record Messaging (XEP-0364)"

    invoke-direct {v1, v3, v4, v5, v6}, Lorg/jivesoftware/smackx/eme/element/ExplicitMessageEncryptionElement$ExplicitMessageEncryptionProtocol;-><init>(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V

    sput-object v1, Lorg/jivesoftware/smackx/eme/element/ExplicitMessageEncryptionElement$ExplicitMessageEncryptionProtocol;->otrV0:Lorg/jivesoftware/smackx/eme/element/ExplicitMessageEncryptionElement$ExplicitMessageEncryptionProtocol;

    .line 3
    new-instance v3, Lorg/jivesoftware/smackx/eme/element/ExplicitMessageEncryptionElement$ExplicitMessageEncryptionProtocol;

    const-string v5, "omemoVAxolotl"

    const/4 v6, 0x2

    const-string v7, "eu.siacs.conversations.axolotl"

    const-string v8, "OMEMO Multi End Message and Object Encryption (XEP-0384)"

    invoke-direct {v3, v5, v6, v7, v8}, Lorg/jivesoftware/smackx/eme/element/ExplicitMessageEncryptionElement$ExplicitMessageEncryptionProtocol;-><init>(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V

    sput-object v3, Lorg/jivesoftware/smackx/eme/element/ExplicitMessageEncryptionElement$ExplicitMessageEncryptionProtocol;->omemoVAxolotl:Lorg/jivesoftware/smackx/eme/element/ExplicitMessageEncryptionElement$ExplicitMessageEncryptionProtocol;

    .line 4
    new-instance v5, Lorg/jivesoftware/smackx/eme/element/ExplicitMessageEncryptionElement$ExplicitMessageEncryptionProtocol;

    const-string v7, "legacyOpenPGP"

    const/4 v8, 0x3

    const-string v9, "jabber:x:encrypted"

    const-string v10, "Legacy OpenPGP for XMPP [DANGEROUS, DO NOT USE!]"

    invoke-direct {v5, v7, v8, v9, v10}, Lorg/jivesoftware/smackx/eme/element/ExplicitMessageEncryptionElement$ExplicitMessageEncryptionProtocol;-><init>(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V

    sput-object v5, Lorg/jivesoftware/smackx/eme/element/ExplicitMessageEncryptionElement$ExplicitMessageEncryptionProtocol;->legacyOpenPGP:Lorg/jivesoftware/smackx/eme/element/ExplicitMessageEncryptionElement$ExplicitMessageEncryptionProtocol;

    const/4 v7, 0x4

    new-array v7, v7, [Lorg/jivesoftware/smackx/eme/element/ExplicitMessageEncryptionElement$ExplicitMessageEncryptionProtocol;
    ...
    .line 5
    sput-object v7, Lorg/jivesoftware/smackx/eme/element/ExplicitMessageEncryptionElement$ExplicitMessageEncryptionProtocol;->$VALUES:[Lorg/jivesoftware/smackx/eme/element/ExplicitMessageEncryptionElement$ExplicitMessageEncryptionProtocol;
