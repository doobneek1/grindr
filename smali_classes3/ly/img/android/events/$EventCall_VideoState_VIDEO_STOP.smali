.class public Lly/img/android/events/$EventCall_VideoState_VIDEO_STOP;
...
.method public static constructor <clinit>()V
    ...
    new-instance v1, Lly/img/android/events/$EventCall_VideoState_VIDEO_STOP;

    invoke-direct {v1}, Lly/img/android/events/$EventCall_VideoState_VIDEO_STOP;-><init>()V
...
.method public call(Lly/img/android/pesdk/backend/model/EventSetInterface;Z)V
    ...
    check-cast v2, Lly/img/android/events/$EventCall_VideoState_VIDEO_STOP$Synchrony;

    invoke-interface {v2, v0, p2}, Lly/img/android/events/$EventCall_VideoState_VIDEO_STOP$Synchrony;->$callEvent_VideoState_VIDEO_STOP(Ljava/lang/Object;Z)V
    :try_end_0
...
.method public callInMainThread(Lly/img/android/pesdk/backend/model/EventSetInterface;Z)V
    ...
    check-cast v2, Lly/img/android/events/$EventCall_VideoState_VIDEO_STOP$MainThread;

    invoke-interface {v2, v0, p2}, Lly/img/android/events/$EventCall_VideoState_VIDEO_STOP$MainThread;->$callEvent_VideoState_VIDEO_STOP_MAIN_TREAD(Ljava/lang/Object;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public callOnWorkerThread(Lly/img/android/pesdk/backend/model/EventSetInterface;Z)V
    ...
    check-cast v2, Lly/img/android/events/$EventCall_VideoState_VIDEO_STOP$WorkerThread;

    invoke-interface {v2, v0, p2}, Lly/img/android/events/$EventCall_VideoState_VIDEO_STOP$WorkerThread;->$callEvent_VideoState_VIDEO_STOP_WORKER_THREAD(Ljava/lang/Object;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
