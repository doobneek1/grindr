...
.method public static synthetic i0(Ljava/util/stream/LongStream;)Lj$/util/stream/x0;
    .locals 1
...
# virtual methods
.method public final synthetic J(Lj$/util/function/q0;)Lj$/util/stream/IntStream;
    .locals 1

    iget-object v0, p0, Lj$/util/stream/v0;->a:Ljava/util/stream/LongStream;

    invoke-static {p1}, Lj$/util/function/p0;->a(Lj$/util/function/q0;)Ljava/util/function/LongToIntFunction;
...
.method public final synthetic K(Lj$/util/function/h0;)Lj$/util/stream/Stream;
    .locals 1

    iget-object v0, p0, Lj$/util/stream/v0;->a:Ljava/util/stream/LongStream;

    invoke-static {p1}, Lj$/util/function/g0;->a(Lj$/util/function/h0;)Ljava/util/function/LongFunction;
...
.method public final synthetic U(Lj$/util/function/e0;)V
    .locals 1

    iget-object v0, p0, Lj$/util/stream/v0;->a:Ljava/util/stream/LongStream;

    invoke-static {p1}, Lj$/util/function/d0;->a(Lj$/util/function/e0;)Ljava/util/function/LongConsumer;
...
.method public final synthetic X(Lj$/util/function/k0;)Z
    .locals 1

    iget-object v0, p0, Lj$/util/stream/v0;->a:Ljava/util/stream/LongStream;

    invoke-static {p1}, Lj$/util/function/j0;->a(Lj$/util/function/k0;)Ljava/util/function/LongPredicate;
...
.method public final synthetic Z(Lj$/util/function/Supplier;Lj$/util/function/D0;Lj$/util/function/BiConsumer;)Ljava/lang/Object;
    .locals 1
    ...
    invoke-static {p2}, Lj$/util/function/C0;->a(Lj$/util/function/D0;)Ljava/util/function/ObjLongConsumer;
...
.method public final synthetic b0(Lj$/util/function/k0;)Z
    .locals 1
...
.method public final synthetic c(Lj$/util/function/k0;)Z
    .locals 1
...
.method public final synthetic c0(Lj$/util/function/k0;)Lj$/util/stream/x0;
    .locals 1
...
.method public final synthetic f(Lj$/util/function/e0;)V
    .locals 1
...
.method public final synthetic findAny()Lj$/util/OptionalLong;
    ...
    invoke-static {v0}, Lj$/util/i;->d(Ljava/util/OptionalLong;)Lj$/util/OptionalLong;
...
.method public final synthetic i(Lj$/util/function/a0;)Lj$/util/OptionalLong;
    .locals 1

    iget-object v0, p0, Lj$/util/stream/v0;->a:Ljava/util/stream/LongStream;

    invoke-static {p1}, Lj$/util/function/Z;->a(Lj$/util/function/a0;)Ljava/util/function/LongBinaryOperator;
    ...
    invoke-static {p1}, Lj$/util/i;->d(Ljava/util/OptionalLong;)Lj$/util/OptionalLong;
...
.method public final synthetic iterator()Lj$/util/v;
    ...
    invoke-static {v0}, Lj$/util/t;->a(Ljava/util/PrimitiveIterator$OfLong;)Lj$/util/v;
...
.method public final synthetic m(Lj$/util/function/n0;)Lj$/util/stream/L;
    .locals 1

    iget-object v0, p0, Lj$/util/stream/v0;->a:Ljava/util/stream/LongStream;

    invoke-static {p1}, Lj$/util/function/m0;->a(Lj$/util/function/n0;)Ljava/util/function/LongToDoubleFunction;
...
.method public final synthetic o(Lj$/util/function/e0;)Lj$/util/stream/x0;
    .locals 1
...
.method public final synthetic p(Lj$/util/function/h0;)Lj$/util/stream/x0;
    .locals 1
...
.method public final synthetic spliterator()Lj$/util/F;
    ...
    invoke-static {v0}, Lj$/util/D;->a(Ljava/util/Spliterator$OfLong;)Lj$/util/F;
...
.method public final synthetic t(Lj$/util/function/u0;)Lj$/util/stream/x0;
    .locals 1

    iget-object v0, p0, Lj$/util/stream/v0;->a:Ljava/util/stream/LongStream;

    invoke-static {p1}, Lj$/util/function/t0;->a(Lj$/util/function/u0;)Ljava/util/function/LongUnaryOperator;
...
.method public final synthetic w(JLj$/util/function/a0;)J
    .locals 1

    iget-object v0, p0, Lj$/util/stream/v0;->a:Ljava/util/stream/LongStream;

    invoke-static {p3}, Lj$/util/function/Z;->a(Lj$/util/function/a0;)Ljava/util/function/LongBinaryOperator;
