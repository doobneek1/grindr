...
# instance fields
.field public final fieldByteLength:I

.field public final requiredSignatureByteLength:I
...
.method public constructor <init>(Lio/jsonwebtoken/SignatureAlgorithm;Ljava/security/Key;)V
    ...
    const-string v2, "EllipticCurve key has a field size of "
    ...
    const-string p1, " requires a field size of "
    ...
    const-string p1, " per [RFC 7518, Section 3.4 (validation)]"

    invoke-virtual {v0, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string p1, "(https://datatracker.ietf.org/doc/html/rfc7518#section-3.4)."
    ...
    const-class p2, Ljava/security/interfaces/ECKey;
