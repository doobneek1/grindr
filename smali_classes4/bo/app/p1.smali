...
.method private final a(Ljava/net/URL;Lorg/json/JSONObject;Ljava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    .line 36
    invoke-static {p1}, Lcom/safedk/android/internal/partials/BrazeNetworkBridge;->urlConnectionGetOutputStream(Ljava/net/URLConnection;)Ljava/io/OutputStream;
...
.method public a(Lbo/app/s4;Ljava/util/Map;Lorg/json/JSONObject;)Lkotlin/Pair;
    ...
    .line 2
    invoke-virtual/range {p1 .. p1}, Lbo/app/s4;->b()Ljava/net/URL;
    ...
    .line 3
    :try_start_0
    invoke-direct {v12, v2, v1, v0}, Lbo/app/p1;->a(Ljava/net/URL;Lorg/json/JSONObject;Ljava/util/Map;)Ljava/net/HttpURLConnection;

    move-result-object v0

    .line 4
    sget-object v1, Lbo/app/p1;->b:Lbo/app/p1$a;

    invoke-static {v1, v0}, Lbo/app/p1$a;->a(Lbo/app/p1$a;Ljava/net/HttpURLConnection;)Ljava/io/InputStream;
    ...
    new-instance v9, Lbo/app/p1$b;

    invoke-direct {v9, v0}, Lbo/app/p1$b;-><init>(Lorg/json/JSONException;)V
    ...
    new-instance v9, Lbo/app/p1$c;

    invoke-direct {v9, v2}, Lbo/app/p1$c;-><init>(Ljava/net/URL;)V
    ...
    const-string v4, "Failed to get result from ["
    ...
    const-string v5, "Failed request to ["
    ...
    invoke-direct {v1, v2, v0}, Lbo/app/o3;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
