...
.method public static constructor <clinit>()V
    ...
    .line 1
    sput-object v1, Lly/img/android/pesdk/ui/model/state/$UiStateMenu_EventAccessor;->synchronyEventNames:[Ljava/lang/String;
    ...
    sput-object v1, Lly/img/android/pesdk/ui/model/state/$UiStateMenu_EventAccessor;->mainThreadEventNames:[Ljava/lang/String;

    new-array v0, v0, [Ljava/lang/String;

    .line 3
    sput-object v0, Lly/img/android/pesdk/ui/model/state/$UiStateMenu_EventAccessor;->workerThreadEventNames:[Ljava/lang/String;
...
# virtual methods
.method public bridge synthetic $callEvent_LayerListSettings_SELECTED_LAYER_MAIN_TREAD(Ljava/lang/Object;Z)V
    .locals 0

    .line 1
    check-cast p1, Lly/img/android/pesdk/ui/model/state/UiStateMenu;

    invoke-virtual {p0, p1, p2}, Lly/img/android/pesdk/ui/model/state/$UiStateMenu_EventAccessor;->$callEvent_LayerListSettings_SELECTED_LAYER_MAIN_TREAD(Lly/img/android/pesdk/ui/model/state/UiStateMenu;Z)V

    return-void
.end method

.method public $callEvent_LayerListSettings_SELECTED_LAYER_MAIN_TREAD(Lly/img/android/pesdk/ui/model/state/UiStateMenu;Z)V
    .locals 0
    ...
    invoke-virtual {p1, p2}, Lly/img/android/pesdk/ui/model/state/UiStateMenu;->onLayerListSettingsChanged(Lly/img/android/pesdk/backend/model/state/LayerListSettings;)V
...
.method public declared-synchronized add(Ljava/lang/Object;)V
    ...
    .line 4
    new-instance v0, Lly/img/android/pesdk/ui/model/state/$UiStateMenu_EventAccessor$1;

    invoke-direct {v0, p0, p1}, Lly/img/android/pesdk/ui/model/state/$UiStateMenu_EventAccessor$1;-><init>(Lly/img/android/pesdk/ui/model/state/$UiStateMenu_EventAccessor;Lly/img/android/pesdk/ui/model/state/UiStateMenu;)V
...
.method public getMainThreadEventNames()[Ljava/lang/String;
    ...
    sget-object v0, Lly/img/android/pesdk/ui/model/state/$UiStateMenu_EventAccessor;->mainThreadEventNames:[Ljava/lang/String;
...
.method public getSynchronyEventNames()[Ljava/lang/String;
    ...
    sget-object v0, Lly/img/android/pesdk/ui/model/state/$UiStateMenu_EventAccessor;->synchronyEventNames:[Ljava/lang/String;
...
.method public getWorkerThreadEventNames()[Ljava/lang/String;
    ...
    sget-object v0, Lly/img/android/pesdk/ui/model/state/$UiStateMenu_EventAccessor;->workerThreadEventNames:[Ljava/lang/String;
